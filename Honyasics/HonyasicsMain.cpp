#include "pch.h"
#include "HonyasicsMain.h"
#include "Common\DirectXHelper.h"
#include "dbgstream.h"

using namespace Honyasics;
...
HonyasicsMain::HonyasicsMain()
{
	...
	*/
	...
	cdbg << "HonyasicsMain" << 1 << std::endl;
}

//レンダラーを作成して、初期化します。
void HonyasicsMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void HonyasicsMain::OnWindowSizeChanged()
{
...
void HonyasicsMain::OnSuspending()
{
...
void HonyasicsMain::OnResuming()
{
	//TODO: これをアプリの再起動ロジックで置き換えます。
}

// デバイス リソースを解放する必要が生じたことをレンダラーに通知します。
void HonyasicsMain::OnDeviceRemoved()
{
